...
ActionMailer::Base.smtp_settings={
    ...
    :user_name => '2728gestion@gmail.com',
    :password => 'bhzknzlmzoxlvczw'
}
...
=end
  ...
  #Hecho por mí para que form_for use la apariencia de Bootstrap
#------------------------------------------------------------------------------
  ...
  # config.active_job.queue_name_prefix = "gestion_site_#{Rails.env}"
