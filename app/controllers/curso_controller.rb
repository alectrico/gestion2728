include Curso::SessionsHelper
include Curso::ApplicationHelper


class CursoController < ActionController::Base
 prepend_view_path 'app/views/curso'

#layout "application"
#layout 'curso_layout_application'
#ayout 'curso'
#efore_filter :profesor_user, except: [:home]
#before_filter :admin_user
#protect_from_forgery

#es important eno borrar

#ayout "static_pages_layout"
