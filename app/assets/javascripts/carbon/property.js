...
(function() {
  ...
  Carbon.Property = function(parent, key, def) {
  ...
  Carbon.Property.prototype.define = function(def) {
  ...
  Carbon.Property.prototype.setValue = function(value) {

    if (this.writable === false && this.value !== undefined) {
      console.warn('Carbon.Element: ' + this.key + ' is read only.');
      return;
    }
    ...
    if (this.type && value !== undefined) {
      if (this.type === String) {
        if (typeof value !== 'string') {
          console.warn('Carbon.Element: ' + this.key + ' is incorrect type.');
          return;
        }
  ...
  Carbon.Property.prototype.setPersistedValue = function() {
  ...
  Carbon.Property.prototype.getPersistedValue = function() {
